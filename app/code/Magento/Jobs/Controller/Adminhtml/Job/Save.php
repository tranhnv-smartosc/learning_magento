<?php
namespace Magento\Jobs\Controller\Adminhtml\Job;
...
class Save extends Action
{
     ...
     * @param \Magento\Jobs\Model\Job $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Jobs\Model\Job $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Magento_Jobs::job_save');
    }
