<?php
namespace Magento\Jobs\Controller\Adminhtml\Department;
...
class Edit extends Action
{
     ...
     * @param \Magento\Jobs\Model\Department $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Magento\Jobs\Model\Department $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Magento_Jobs::department_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magento_Jobs::department')
