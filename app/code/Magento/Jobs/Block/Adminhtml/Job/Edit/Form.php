<?php
namespace Magento\Jobs\Block\Adminhtml\Job\Edit;
...
class Form extends Generic
{
     ...
     * @param \Magento\Jobs\Model\Source\Job\Status $status
     * @param \Magento\Jobs\Model\Source\Department $department
     * @param array $data
     */
    public function __construct(
        ...
        \Magento\Jobs\Model\Source\Job\Status $status,
        \Magento\Jobs\Model\Source\Department $department,
        array $data = []
    ) {
    ...
    {
        /** @var \Magento\Jobs\Model\Job $model */
